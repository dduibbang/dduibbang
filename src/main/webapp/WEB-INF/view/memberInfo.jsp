...
<body style="background-color: #F7C123;">
    <div class="tab">
        ...
        <div style="display: flex; margin-left: 5%">
            ...
            <div>
                <button type="button" class="btn-point" onclick="">추가 적립</button>
            </div>
        </div>
            ...
            <div class="left">
                <div class="dd-padding form-group">
                    ...
                    <div class="right-info">
                        <input type="text" class="form-control" maxlength="30" value="${userInfo.mbr_id}" readonly>
                        <br>
                        <br>
                        <input type="button" class="form-control" style="width: 250px" value="비밀번호 변경하기" onclick="updatePW()">
                        <br>
                        <br>
                        <input type="text" class="form-control" maxlength="30" value="${userInfo.mbr_nm}">
                        <br>
                        <br>
                        <input type="text" class="form-control" maxlength="30" value="${userInfo.mbr_tel}">
                        <br>
                        <br>
                        <input type="text" class="form-control" maxlength="30" value="${userInfo.mbr_email}">
                        <br>
                        <br>
